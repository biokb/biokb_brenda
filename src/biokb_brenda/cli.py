...
@click.group()
def cli():
    """BioKB Brenda CLI - Manage brenda: Import in RDBMS, create turtle files and import into Neo4J.
...
@click.option(
    ...
    "--connection-string",
    type=str,
    default="sqlite:///brenda.db",
    help="SQLAlchemy engine URL [default: sqlite:///brenda.db]",
)
